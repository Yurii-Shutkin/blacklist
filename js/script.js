...
(() => {
    ...
    const todoList = {
        ...
        createTemplate({title, description, itemId, completed}) {
            const todoItem = this.createElement('div');
            ...
            const span = this.createElement('span', 'checkbox-value', 'Заслуживает смерть ');
            const deleteTaskBtn = this.createElement('button', ['btn', 'delete-item-btn'], 'Простить засранца');
